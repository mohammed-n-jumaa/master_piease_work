@include('userspages.layouts.header')
...
<div class="container">
        ...
        <div class="profile-card">
            ...
            <div class="profile-content">
                <div class="profile-picture">
                    <img src="{{ $lawyer->profile_picture ? asset($lawyer->profile_picture) : asset('default-profile-picture.jpg') }}"
                        alt="Profile Picture">
                </div>
                ...
                <form action="{{ route('appointments.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" id="appointment_time" name="appointment_time" class="form-control"
                            required min="{{ \Carbon\Carbon::now()->format('H:i') }}">
                    </div>
    ...
    <div id="reviews-section" class="content-section">
        ...
        @endif
        @include('userspages.layouts.footer')
        <script src="{{ asset('user/js/lawprof.js') }}"></script>
